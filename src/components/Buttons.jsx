...
export const Buttons = () => {
  ...
  const DATA = [
    {
      href: 'https://github.com/bran921007/',
      aria: 'Visit my GitHub profile',
      icon: <GitHub />,
      label: 'GitHub',
    },
    {
      href: 'https://www.linkedin.com/in/francisco-p/',
      aria: 'Visit my LinkedIn profile',
      icon: <LinkedIn />,
      label: 'LinkedIn',
    },
    {
      href: 'https://drive.google.com/file/d/1NHDCPgl-vIo7fFcrICzTDYhIJgkXh7MF/view?usp=sharing',
      aria: 'Visit Google Drive to view and download my resume',
      icon: <Resume />,
      label: 'Resume',
    },
    {
      href: 'mailto:franciscoperez583@gmail.com',
