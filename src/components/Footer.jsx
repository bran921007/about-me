...
export const Footer = () => {
  ...
  return (
    <F.Container isMobile={isMobile}>
      <F.Text theme={theme} aria-label='Designed and built by Francisco Perez'>Designed and built by&nbsp;
        <F.Link theme={theme} data-v2='creator' href='https://www.adamalston.com/'>Francisco Perez</F.Link>
        {isMobile ? (
          <></>
        ) : (
          <>
